...
exports.saveDoc = function(req, res) {
  ...
  // // From Shortly, do not believe it to be relevant to us
...
exports.deleteDocument = function(req, res) {
  ...
  Doc.findOne({ '_id': req.params.id }).remove().exec();
};
...
exports.logoutUser = function (req, res){
  // removes the session on the server and executes the function on completion
  req.session.destroy(function (){
    // sends the response to redirect to '/login' on client
    res.redirect('/login'); 
  });
}
