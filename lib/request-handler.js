...
exports.deleteDocument = function(req, res) {
  ...
  Doc.findOneAndRemove({ 'url': url }, function(err){
    if (!err) {
      console.log('Successful document deletion from database.');
    } else {
      console.error('Deletion of document from database failed.');
    }
  })
};
